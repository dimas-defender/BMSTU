...
{
    QString fileName = QFileDialog::getOpenFileName(this, "Open model", "/home/volodya/Desktop/zhabin/lab3/data/", "Text file (*.txt)");
...
void MainWindow::on_rot_dial_actionTriggered()
{
    ui->angle_lbl_2->setText(QString("Rotation angle = %1").arg(ui->rot_dial->value()));
}

void MainWindow::on_scl_dial_actionTriggered()
{
    ui->coefficient_lbl_2->setText(QString("Scale coefficient = %1").arg(ui->scl_dial->value() / 10.0));
}

void MainWindow::on_move_dial_actionTriggered()
{
    ui->div_lbl_2->setText(QString("Coordinates step = %1").arg(ui->move_dial->value()));
}
