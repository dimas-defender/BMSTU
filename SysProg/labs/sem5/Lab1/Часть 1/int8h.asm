...
020A:0750  8E D8			mov	ds,ax		; Установка ds
020A:0752  33 C0			xor	ax,ax		; Zero register
020A:0754  8E C0			mov	es,ax		; Установка es

;; Инкремент счётчика реального времени по известному адресу в области данных BIOS
;; Инкремент младшей части счётчика реального времени по адресу 0040:006C
020A:0756  FF 06 006C		inc	word ptr ds:[6Ch]	; (0040:006C=0E873h)
020A:075A  75 04			jnz	loc_1				; Jump if not zero
;; Инкремент старшей части счётчика реального времени по адресу 0040:006E
...
;; Обнуление старшей части счётчика реального времени по адресу 0040:006E
020A:076F  A3 006E			mov	word ptr ds:[6Eh],ax  ; (0040:006E=0Ch)
;; Обнуление младшей части счётчика реального времени по адресу 0040:006C
...
020A:078E			loc_3:
020A:078E  58				pop	ax
;; Проверка, установлен ли флаг четности PF
