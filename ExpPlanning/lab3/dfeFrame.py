...
class DfeFrame(tk.Frame):
    def __init__(self, master): 
        ...
        self.MainTable = Table(master=canvas, rows=34, columns=28)
        ...
        self.formula_frame.grid(column=0, row=2, pady=20)
    ...
    def count_one(self, lam, sig, mu, lam2=None, sig2=None, mu2=None):
        ...
        self.MainTable.set_row(33, line, 1)
    ...
    def run(self, lambda_min, lambda_max, sigma_min, sigma_max, mu_min, mu_max,
        ...
        x6 = [x1[i]*x2[i]*x3[i]*x4[i]*x5[i] for i in range(len(x1))]
