...
dfe_experiment.configure(background = ITEMS_COLOR)
...
def work_one(Event):
    ...
    dfe_experiment.count_one(lam, sig, mu, lam2, sig2, mu2)
...
def pfe_inputs(root):   
    ...
    items_2 = [
        ...
        i.Item(text="Максимум:", var=varList["sigma_max"], value=0.02), 
    ]
    items_3 = [
    ...
    items_4 = [
        i.Item(text="Минимум:", var=varList["sigma2_min"], value=0), 
        i.Item(text="Максимум:", var=varList["sigma2_max"], value=0.02),
    ]
    items_5 = [
...
def draw_new_point(root):
    items = [
        ...
        i.Item(text="Разброс интенсивности поступления заявок 1:", var=varList["sigma"], value=0.01),
        i.Item(text="Интенсивность поступления заявок 2:", var=varList["lambda2"], value=20),
        i.Item(text="Разброс интенсивности поступления заявок 2:", var=varList["sigma2"], value=0.01),
...
if __name__ == '__main__':
    ...
    nb.grid(row=2, columnspan=2, padx=50, pady=10)
